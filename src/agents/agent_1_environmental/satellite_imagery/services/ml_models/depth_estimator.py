...
import numpy as np
import pickle
from typing import Dict, Tuple, Optional, Union, List, TYPE_CHECKING, Any
...
# Type checking imports - only used by Pylance, not at runtime
if TYPE_CHECKING:
...
class FloodDepthEstimator:
    ...
    def __init__(
        ...
        **model_params
        ...
        self.training_metrics: Optional[DepthEstimationMetrics] = None
        
        # Model can be sklearn or keras - use Any to avoid type checking issues
        self.model: Any = None
    ...
    def _create_neural_network(self, params: Dict) -> Any:
        """
    ...
    def train(
        ...
        # Train model - with type narrowing for neural networks
        if self.model_type == 'neural_network':
            # For neural networks, we know TF_AVAILABLE is True (checked in __init__)
            ...
            if TF_AVAILABLE and hasattr(self.model, 'fit'):
                ...
                if X_val is not None and y_val is not None:
                    ...
                    history = self.model.fit(  # type: ignore[call-arg]
        ...
        if X_val is not None and y_val is not None:
            ...
            # Evaluate on training set (not ideal but provides feedback)
    ...
    def get_feature_importance(self) -> Dict[str, float]:
        ...
        # Type narrowing for sklearn models
